...
def fgcoot_numpy(X1, X2, D1, D2, S1=None,S2=None, w1 = None, w2 = None, v1 = None, v2 = None, alpha=1.0,
	...
	for i in range(niter):
		...
		if C_lin is not None:
			M=M+C_lin  
		Ts=fgw_lp(M,D1,D2,w1,w2,loss_fun='square_loss',alpha=alpha,amijo=True,G0=Ts) 
