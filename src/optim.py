...
def cg(a, b, M, reg, f, df, G0=None, algo="emd", reg=None, numItermax=200, numItermaxEmd=100000,
    ...
    **kwargs : dict
    ...
    while loop:
        ...
        if algo=="emd":
            ...
            Gc, logsink = ot.sinkhorn(a, b, Mi, reg, method='sinkhorn', numItermax=numItermaxEmd, stopThr=1e-09, verbose=False, log=True, warn=True)
